...
def build_manifest(
    *,
    ...
    return {
        ...
        "notes": (
            "Public U.S. arrest / booking archive. "
            "Clients apply arrests.delta.NNNN.zip after the base zip when present. "
            "Mugshots ship as arrests.photos.NNN.zip under data/photos/. "
            "Local ethnicity_review / race_manual flags are preserved on client sync."
        ),
    }
