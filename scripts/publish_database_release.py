...
REPO = "HyperboreanSlug/MAPA"
TAG = "database-latest"
PHOTO_GLOB = "arrests.photos.*.zip"
DELTA_GLOB = "arrests.delta.*.zip"
...
def main() -> int:
    ...
    zip_path = ROOT / "releases" / "arrests.db.zip"
    ...
    if not token:
        ...
        print(
            ...
            f'--title "Public database" --notes "Public arrest archive"\n'
        )
        return 2
